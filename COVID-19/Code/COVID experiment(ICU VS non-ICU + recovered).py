...
# ![Spearman%20VS%20Pearson.png](attachment:Spearman%20VS%20Pearson.png)
...
np.savetxt('D:\\COMP 495\\COVID-19\\COVID-19 project_Brodinlab\\Influence factor comparison(not ICU VS ICU).csv', result, delimiter=",", newline = "\n", fmt="%s")
...
for i in range(0, non_ICU_patients_datas_validation.shape[0]):
    ...
    print("not ICU patient: is determined to be a " + result[0] + " patient")
    if (result[0] == 'not ICU'):
        knn_score = knn_score + 1
